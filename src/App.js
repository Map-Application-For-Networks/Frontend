...
// This part is developed to prevent the error occurs when the different markers has the same location. It will add small offset.
function applyOffset(marker, index, totalMarkers) {
